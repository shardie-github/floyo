...
// Optional bundle analyzer - only enabled when ANALYZE=true
...
if (process.env.ANALYZE === 'true') {
  try {
    ...
    console.warn('[CRUX+HARDEN] Bundle analyzer not installed. Run: npm install --save-dev @next/bundle-analyzer');
  }
}
