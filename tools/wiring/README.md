...
The Wiring Harness is a comprehensive end-to-end connectivity verification system for the Nomad monorepo. It tests all subsystems to ensure they are properly connected and functioning.
